'use strict';
(function () {
    mtcApp.factory('editInvoiceService', function ($http, $log, $q, $rootScope, $location) {
        return {
            ...
            removeHolidayDate: function (id) {
                console.time('Removing Holiday Date');
                return $http({
                    method: 'GET',
                    url: $(".websiteUrl").text().trim() + '/Scheduling/RemoveHolidayDate?id=' + id
                }).
                then(function (response) {
                    console.timeEnd('Removing Holiday Dates');
                    return response.data;
                });
            },
            ...
            getCanEdit: function () {
                ...
                return $http({
                    method: 'GET',
                    url: $(".websiteUrl").text().trim() + '/DailySchedule/CanEdit'
                }).
                then(function (response) {
