(function () {
    'use strict';
    mtcApp.controller('troubleTicketTowContractorController',
        function troubleTicketTowContractorController($scope, $filter, $rootScope, $location, $routeParams, $interval, generalService, troubleTicketService) {
            ...
            $scope.redirectToBackupRequest = false;
            ...
            generalService.getCurrentUser().then(function (results) {
                if (results) {
                    if (results.SelectedRoleName === 'TowContractor' && results.ContractorTypeName == 'Tow-Contractor') {
                        ...
                        $scope.associatedTowContractorId = results.ContractorId;
                        ...
                        alert("You are not a tow-contractor.")
                    }
                }
                else {
            ...
            $scope.toggleTicketProblemSelection = function (id) {
            ...
            $scope.showManageTroubleTicketModal = function () {
                ...
                if ($scope.ticketType === 0)
                    $("#manageMechanicalTroubleTicketModal").modal("show");
                else if ($scope.ticketType === 1)
            ...
            $scope.saveTroubleTicketAndRequestBackup = function () {

                $scope.redirectToBackupRequest = true;
                $scope.saveTroubleTicket();
            ...
            $scope.saveTroubleTicket = function () {
                ...
                troubleTicketService.saveTroubleTicket(vm).then(function (result) {
                    ...
                    $("#manageMechanicalTroubleTicketModal").modal("hide");
                    $("#manageInVehicleEquipmentTroubleTicketModal").modal("hide");
                    $("#manageInVehicleEquipmentLATATraxTroubleTicketModal").modal("hide");


                    if ($scope.redirectToBackupRequest === true) {
                        //window.location.href = $(".websiteUrl").text().trim() + '/BackupTrucks/RequestBackup';
                        window.open($(".websiteUrl").text().trim() + "/BackupTrucks/RequestBackup", "_blank");
                    }
            ...
            $scope.resolveTroubleTicket = function () {
                ...
                var vm = {
                    ...
                    Comments: $scope.contractorNotes
                };
