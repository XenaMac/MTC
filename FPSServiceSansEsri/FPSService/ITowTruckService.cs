...
namespace FPSService
{
    ...
    public interface ITowTruckService
    {
        ...
        [OperationContract]
        void deleteBeat(Guid id);

        [OperationContract]
        void deleteBeatSegment(Guid id);

        [OperationContract]
        void deleteCallBox(Guid id);

        [OperationContract]
        void deleteDropSite(Guid id);

        [OperationContract]
        void deleteYard(Guid id);

        [OperationContract]
        void setActiveBeats(string beats);

        [OperationContract]
        string getActiveBeats();
        ...
        #region " New Esri-Free Stuff "

        [OperationContract]
        List<beatInformation> getAllBeats();

        [OperationContract]
        beatInformation getBeatByBeatID(string BeatID);

        [OperationContract]
        List<beatSegmentPolygonData> getAllSegmentPolygons();

        [OperationContract]
        beatSegmentPolygonData getSegmentPolygon(string SegmentID);

        [OperationContract]
        beatSegmentPolygonData getSegmentPolygonById(Guid id);

        [OperationContract]
        List<yardPolygonData> getAllYards();

        [OperationContract]
        yardPolygonData getYardPolygon(string YardID);

        [OperationContract]
        List<dropSitePolygonData> getAllDropSites();

        [OperationContract]
        dropSitePolygonData getDropSite(string DropSiteID);

        [OperationContract]
        List<esriCB> getAllCallBoxes();

        [OperationContract]
        esriCB getCallBoxByID(string callBoxID);

        [OperationContract]
        void updateBeatInfoData(beatInformation b);

        [OperationContract]
        void updateBeatSegmentData(beatSegmentPolygonData b);

        [OperationContract]
        void updateYardData(yardPolygonData y);

        [OperationContract]
        void updateDropSiteData(dropSitePolygonData d);

        [OperationContract]
        void updateCallBox(esriCB c);
    ...
    public class TruckMessage
    {
        ...
        public double lon { get; set; }
        [DataMember]
        public string WazeUUID { get; set; }
        [DataMember]
        public string WazeType { get; set; }
        [DataMember]
        public string WazeSubType { get; set; }
    }
    ...
    #region " Esri-Free Classes "

    [DataContract]
    public class beatInformation {
        [DataMember]
        ...
        [DataMember]
        public List<string> beatSegmentList { get; set; }
    }
    ...
    public class esriCB
    {
        ...
        public Guid ID { get; set; }
        [DataMember]
        public string CallBoxID { get; set; }
        [DataMember]
        public string CallBoxNumber { get; set; }
        [DataMember]
        public string Location { get; set; }
        [DataMember]
        public double Lat { get; set; }
