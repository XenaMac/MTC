...
<body>
    <form id="form1" runat="server">
        <div id="Title" class="titleBar"> <!--Start Whole Div-->
           <div class="logoSection"> <!--Start Logo Section -->
                    ...
                    <img alt="bar" class="bannerelement" longdesc="bar" src="../Images/VertBar.png" />
                    <h1 class="bannerelement"> Tow Truck Yards
                </h1>
    ...
    <div>
        ...
        <asp:Button ID="btnReloadYards" runat="server" onclick="btnReloadYards_Click" CssClass="myButton"
            Text="Reload Yards" />
    </div>
        <br />
    <div id="YardsDiv">
    <div class="subTitle"><label>Beat Data</label></div>
        <br />
        <asp:GridView ID="gvYards" runat="server" CssClass="dashboardTable" AutoGenerateColumns="False">
            <Columns>
                <asp:BoundField DataField="YardID" HeaderText="YardID" SortExpression="YardID" />
