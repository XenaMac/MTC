...
namespace FPSService.SQL
{
    public class SQLCode
    {
        ...
        public void loadActiveBeats() {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    string SQL = "SELECT VarValue FROM Vars WHERE VarName = 'ActiveBeats'";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    string varVal = cmd.ExecuteScalar().ToString();
                    cmd = null;
                    conn.Close();
                    WAZE.GetWAZE.setActiveBeats(varVal);
                }
            }
            catch (Exception ex) {
        ...
        public void setActiveBeats(string beats) {
            try {
                ...
                {
                    conn.Open();
                    string SQL = "UPDATE Var SET VarValue = '" + beats + "' WHERE VarName = 'ActiveBeats'";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
        ...
        public void loadBeatInformation() {
            try {
                BeatData.Beats.beatInfos.Clear();
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();

                    string SQL = "SELECT ID, BeatID,BeatName, Notes, Color, UserCreated, UserModified, DateCreated, DateModified FROM BeatData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read()) {
                        beatInformation bi = new beatInformation();
                        bi.ID = new Guid(rdr["ID"].ToString());
                        bi.BeatID = rdr["BeatID"].ToString();
                        bi.notes = rdr["Notes"].ToString();
                        bi.BeatName = rdr["BeatName"].ToString();
                        bi.Color = rdr["Color"].ToString();
                        bi.dateCreated = rdr.IsDBNull(7) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateCreated"]);
                        bi.dateModified = rdr.IsDBNull(8) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateModified"]);
                        bi.UserCreated = rdr["UserCreated"].ToString();
                        bi.UserModified = rdr["UserModified"].ToString();
                        bi.beatSegmentList = new List<string>();
                        BeatData.Beats.beatInfos.Add(bi);
                    }
                    rdr.Close();
                    rdr = null;
                    cmd = null;
                    foreach (beatInformation bi in BeatData.Beats.beatInfos) {
                        SQL = "BeatSegmentLoader";
                        cmd = new SqlCommand(SQL, conn);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@BeatID", bi.BeatID);
                        rdr = cmd.ExecuteReader();
                        while (rdr.Read())
                        {
                            bi.beatSegmentList.Add(rdr["SegmentID"].ToString());
                        }
                        rdr.Close();
                        rdr = null;
                        cmd = null;
                ...
                log.LogEvent(ex.Message, true);
            }
        }

        /*
        public void loadBeatData()
        { //new beats loaded from db, depecrated - use load beat infromation above
            try
            {
                BeatData.Beats.beatList.Clear();
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "SELECT ID, BeatID,BeatName, Notes, BoundaryData, PointData, GeoType, Radius, Color, UserCreated, UserModified, DateCreated, DateModified FROM BeatData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandTimeout = 0;
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
                        beatPolygonData b = new beatPolygonData();
                        b.ID = new Guid(rdr["ID"].ToString());
                        b.BeatID = rdr["BeatID"].ToString();
                        b.notes = rdr["Notes"].ToString();
                        b.BeatName = rdr["BeatName"].ToString();
                        ...
                        b.Color = rdr["Color"].ToString();
                        b.dateCreated = rdr.IsDBNull(10)?Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateCreated"]);
                        b.dateModified = rdr.IsDBNull(10) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateModified"]);
                        b.UserCreated = rdr["UserCreated"].ToString();
                        b.UserModified = rdr["UserModified"].ToString();
        ...
        */
        public void loadBeatSegmentData()
        {
            try
            {
                ...
                {
                    conn.Open();
                    string SQL = "SELECT ID, SegmentID, SegmentDescription, BoundaryData, PointData, Color, UserCreated, UserModified, DateCreated, DateModified FROM BeatSegmentData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandTimeout = 0;
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
                        beatSegmentPolygonData b = new beatSegmentPolygonData();
                        b.ID = new Guid(rdr["ID"].ToString());
                        //b.beatID = rdr["BeatID"].ToString();
                        ...
                        b.dateCreated = rdr.IsDBNull(8) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateCreated"]);
                        b.dateModified = rdr.IsDBNull(9) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateModified"]);
                        b.UserCreated = rdr["UserCreated"].ToString();
                        b.UserModified = rdr["UserModified"].ToString();
        ...
        public void loadDropSiteData()
        {
            ...
            try
            {
                BeatData.DropSites.dropSites.Clear();
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "SELECT ID, BeatID, DropSiteID, DropSiteDescription, BoundaryData, PointData, Color, UserCreated, UserModified, DateCreated, DateModified FROM DropSiteData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandTimeout = 0;
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
                        dropSitePolygonData d = new dropSitePolygonData();
                        d.ID = new Guid(rdr["ID"].ToString());
                        dsID = d.ID;
                        d.beatID = rdr["BeatID"].ToString();
                        ...
                        d.Color = rdr["Color"].ToString();
                        d.userCreated = rdr["UserCreated"].ToString();
                        d.userModified = rdr["UserModified"].ToString();
                        d.dateCreated = rdr.IsDBNull(9) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateCreated"]);
                        d.dateModified = rdr.IsDBNull(9) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateModified"]);
                        //BeatData.DropSites.addDropSite(d);
                        BeatData.DropSites.dropSites.Add(d);
                    }
                    conn.Close();
                }
            }
        ...
        public void loadCallBoxData() {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    string SQL = "SELECT ID, CallBoxID, CallBoxNumber, lat, lon, location FROM CallBoxData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandTimeout = 0;
                    SqlDataReader rdr = cmd.ExecuteReader();
                    BeatData.CallBoxes.callBoxList.Clear();
                    while (rdr.Read()) {
                        esriCB c = new esriCB();
                        c.ID = new Guid(rdr["ID"].ToString());
                        c.CallBoxID = rdr["CallBoxID"].ToString();
                        c.CallBoxNumber = rdr["CallBoxNumber"].ToString();
                        c.Location = rdr["location"].ToString();
                        c.Lat = Convert.ToDouble(rdr["lat"]);
                        c.Lon = Convert.ToDouble(rdr["lon"]);
                        BeatData.CallBoxes.callBoxList.Add(c);
                    }
                    rdr.Close();
                    rdr = null;
                    cmd = null;
        ...
        public void loadYardData()
        {
            try
            {
                BeatData.Yards.yards.Clear();
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "SELECT ID, YardID, BeatID, Contractor, Address, City, Zip, Phone, BoundaryData, PointData, Color, UserCreated, UserModified, DateCreated, DateModified FROM YardData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandTimeout = 0;
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
                        yardPolygonData y = new yardPolygonData();
                        ...
                        y.Zip = rdr["Zip"].ToString();
                        y.Phone = rdr["Phone"].ToString();
                        y.Color = rdr["Color"].ToString();
                        string[] splitBoundary = rdr["BoundaryData"].ToString().Split(',');
                        if (splitBoundary.Length > 0)
                        {
                        ...
                        y.UserCreated = rdr["UserCreated"].ToString();
                        y.UserModified = rdr["UserModified"].ToString();
                        y.dateCreated = rdr.IsDBNull(10) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateCreated"]);
                        y.dateModified = rdr.IsDBNull(10) ? Convert.ToDateTime("01/01/2001 00:00:00") : Convert.ToDateTime(rdr["DateModified"]);
                        //BeatData.Yards.addYard(y);
                        BeatData.Yards.yards.Add(y);
                    }
                    conn.Close();
                }
            }
        ...
        public void LoadBeatsFreeways()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    ...
                    string SQL = "SELECT DISTINCT ID, BeatName FROM BeatData";
                    ...
                    while (rdr.Read())
                    {
                        ...
                        bf.BeatID = new Guid(rdr["ID"].ToString());
                        bf.BeatNumber = rdr["BeatName"].ToString();
                        bf.BeatDescription = "";
                        bf.Active = true;
        ...
        public string findBeatID(string beatNumber, string beatdescription)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    ...
                    string SQL = "SELECT BeatID FROM BeatData WHERE BeatNumber = '" + beatNumber + "'";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
                    ...
                    else
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        cmd = null;
                        SQL = "SELECT BeatID FROM BeatData WHERE BeatNumber = '" + beatNumber + "'";
                        cmd = new SqlCommand(SQL, conn);
                        rdr = cmd.ExecuteReader();
                        while (rdr.Read())
                        {
        ...
        public List<string> getBeatNumbers()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    ...
                    string SQL = "SELECT DISTINCT BeatNumber FROM BeatData ORDER BY BeatNumber";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    SqlDataReader rdr = cmd.ExecuteReader();
                    while (rdr.Read())
                    {
        ...
        public string GetMACAddress(string ID)
        {
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string SQL = "SELECT IPAddress FROM FleetVehicles WHERE TAIP = '" + ID + "'";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
        ...
        public Guid GetBeatIDByBeatNumber(string _BeatNumber)
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    ...
                    string SQL = "SELECT ID FROM BeatData WHERE BeatName = '" + _BeatNumber + "'";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
        ...
        */
        ...
        /* DEPRECATED - Very old beat model
        ...
        public void LoadFreeways()
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    ...
                    while (rdr.Read())
                    {
                        BeatData.Beats.freeways.Add(rdr[0].ToString());
                    }
        ...
        */
        ...
        #region " Waze Incoming "

        public void logIncomingWaze(WAZE.wazeXML w) {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    string SQL = "LogWazeIncoming";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@UUID", w.uuid);
                    cmd.Parameters.AddWithValue("@Title", w.title);
                    cmd.Parameters.AddWithValue("@PubDate", w.pubDate);
                    cmd.Parameters.AddWithValue("@Type", w.type);
                    cmd.Parameters.AddWithValue("@SubType", w.subtype);
                    cmd.Parameters.AddWithValue("@Lat", w.lat);
                    cmd.Parameters.AddWithValue("@Lon", w.lon);
                    cmd.Parameters.AddWithValue("@RoadType", w.roadType);
                    cmd.Parameters.AddWithValue("@Reliability", w.reliability);
                    cmd.Parameters.AddWithValue("@Confidence", w.confidence);
                    cmd.Parameters.AddWithValue("@NThumbsUp", w.nThumbsUp);
                    cmd.Parameters.AddWithValue("@Street", w.street);
                    cmd.Parameters.AddWithValue("@City", w.city);
                    cmd.Parameters.AddWithValue("@Segment", w.segment);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
                }
                ...
                logger = new Logging.EventLogger();
                logger.LogEvent("ERROR Logging Waze Data:" + ex.ToString(), true);
            }
        }

        public void logAckedWaze(WAZE.wazeXML w) {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@UUID", w.uuid);
                    cmd.Parameters.AddWithValue("@Accepted", w.accepted);
                    cmd.Parameters.AddWithValue("@AckMessage", w.ackMessage);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
                }
        ...
        public void dispatchWaze(WAZE.wazeXML w)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "DispatchWaze";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@uuid", w.uuid);
                    cmd.Parameters.AddWithValue("@VehicleNumber", w.dispatchVehicle);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
                }
        ...
        public void logData(string type, string val) {
            string logVal = ConfigurationManager.AppSettings["logincoming"].ToString();
            if (logVal != "true") {
                return;
            }
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("LogData", conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                ...
                logger.LogEvent(DateTime.Now.ToString() + Environment.NewLine + "Error logging incoming data " + Environment.NewLine + ex.ToString(), true);
            }
        }
        ...
        public void updateBeatInfos(beatInformation b)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "addBeatData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    //string geoFence = string.Empty;
                    //geoFence = geoFence.Substring(0, geoFence.Length - 1);
                    cmd.Parameters.AddWithValue("@ID", b.ID);
                    cmd.Parameters.AddWithValue("@BeatID", b.BeatID);
                    cmd.Parameters.AddWithValue("@BeatName", b.BeatName);;
                    cmd.Parameters.AddWithValue("@notes", b.notes);
                    cmd.Parameters.AddWithValue("@UserCreated", b.UserCreated);
                    cmd.Parameters.AddWithValue("@UserModified", b.UserModified);
                    ...
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@BeatID", b.ID);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    foreach (string s in b.beatSegmentList) {
                        cmd = new SqlCommand("AssociateBeatSegment", conn);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@BeatID", b.BeatID);
                        cmd.Parameters.AddWithValue("@BeatSegmentID", s);
                        cmd.ExecuteNonQuery();
                        cmd = null;
                    }
                    conn.Close();
        ...
        //deprecated - use updateBeatInfos()
        /*
        public void updateBeatPolygon(beatPolygonData b) {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    string SQL = "addBeatData";
                    ...
                    foreach (latLon ll in b.geoFence) {
                        geoFence += ll.lat + "," + ll.lon + "|";
                    }
                    geoFence = geoFence.Substring(0, geoFence.Length - 1);
                    cmd.Parameters.AddWithValue("@ID", b.ID);
                    cmd.Parameters.AddWithValue("@BeatID", b.BeatID);
                    cmd.Parameters.AddWithValue("@BeatName", b.BeatName);
                    string boundary = b.maxLat.ToString() + "," + b.maxLon.ToString() + "," + b.minLat.ToString() + "," + b.minLon.ToString();
                    cmd.Parameters.AddWithValue("@BoundaryData", boundary);
                    cmd.Parameters.AddWithValue("@PointData", geoFence);
                    cmd.Parameters.AddWithValue("@GeoType", b.geoType);
                    cmd.Parameters.AddWithValue("@notes", b.notes);
                    cmd.Parameters.AddWithValue("@UserCreated", b.UserCreated);
                    cmd.Parameters.AddWithValue("@UserModified", b.UserModified);
                    cmd.Parameters.AddWithValue("@dateCreated", b.dateCreated);
                    cmd.Parameters.AddWithValue("@dateModified", b.dateModified);
                    cmd.Parameters.AddWithValue("@radius", b.radius);
                    cmd.Parameters.AddWithValue("@Color", b.Color);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
        ...
        */
        public void updateBeatSegmentPolygon(beatSegmentPolygonData b) {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "addBeatSegmentData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    string geoFence = string.Empty;
                    foreach (latLon ll in b.geoFence)
                    ...
                    cmd.Parameters.AddWithValue("@ID", b.ID);
                    //cmd.Parameters.AddWithValue("@BeatID", b.beatID);
                    cmd.Parameters.AddWithValue("@segmentID", b.segmentID);
                    cmd.Parameters.AddWithValue("@segmentDescription", b.segmentDescription);
                    cmd.Parameters.AddWithValue("@pointData", geoFence);

                    string boundaryData = b.maxLat + "," + b.maxLon + "," + b.minLat + "," + b.minLon;
                    cmd.Parameters.AddWithValue("@boundaryData", boundaryData);
        ...
        public void updateYardPolygon(yardPolygonData y) {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "addYardData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    string pLatLon = string.Empty;
                    foreach (latLon ll in y.geoFence)
                    {
                        pLatLon += ll.lat + "," + ll.lon + "|";
                    }
                    pLatLon = pLatLon.Substring(0, pLatLon.Length - 1);
                    cmd.Parameters.AddWithValue("@ID", y.ID);
                    cmd.Parameters.AddWithValue("@YardID", y.YardID);
                    cmd.Parameters.AddWithValue("@BeatID", y.BeatID);
                    cmd.Parameters.AddWithValue("@Contractor", y.Contractor);
                    cmd.Parameters.AddWithValue("@Address", y.Address);
                    cmd.Parameters.AddWithValue("@City", y.City);
                    cmd.Parameters.AddWithValue("@Zip", y.Zip);
                    cmd.Parameters.AddWithValue("@Phone", y.Phone);
                    string boundaryData = y.maxLat.ToString() + "," + y.maxLon.ToString() + "," + y.minLat.ToString() + "," + y.minLon.ToString();
                    cmd.Parameters.AddWithValue("@BoundaryData", boundaryData);
                    cmd.Parameters.AddWithValue("@PointData", pLatLon);
                    cmd.Parameters.AddWithValue("@UserCreated", y.UserCreated);
                    cmd.Parameters.AddWithValue("@UserModified", y.UserModified);
                    cmd.Parameters.AddWithValue("@dateCreated", DateTime.Now);
                    cmd.Parameters.AddWithValue("@dateModified", DateTime.Now);
                    cmd.Parameters.AddWithValue("@Color", y.Color);
                    cmd.ExecuteNonQuery();
                    cmd = null;
                    conn.Close();
                }
        ...
        public void updateDropSitePolygon(dropSitePolygonData d) {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "addDropSiteData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    string pLatLon = string.Empty;
                    ...
                    cmd.Parameters.AddWithValue("@BeatID", d.beatID);
                    cmd.Parameters.AddWithValue("@DropSiteID", d.dropSiteID);
                    cmd.Parameters.AddWithValue("@DropSiteDescription", d.dropSiteDescription);
                    string boundaryData = d.maxLat.ToString() + "," + d.maxLon.ToString() + "," + d.minLat.ToString() + "," + d.minLon.ToString();
                    cmd.Parameters.AddWithValue("@BoundaryData", boundaryData);
                    cmd.Parameters.AddWithValue("@PointData", pLatLon);
                    cmd.Parameters.AddWithValue("@UserCreated", d.userCreated);
                    cmd.Parameters.AddWithValue("@UserModified", d.userModified);
                    cmd.Parameters.AddWithValue("@DateCreated", DateTime.Now);
                    cmd.Parameters.AddWithValue("@DateModified", DateTime.Now);
        ...
        public void updateCallBoxData(esriCB c) {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();

                    string SQL = "addCallBox";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", c.ID);
                    cmd.Parameters.AddWithValue("@CallBoxID", c.CallBoxID);
                    cmd.Parameters.AddWithValue("@CallBoxNumber", c.CallBoxNumber);
        ...
        public void deleteBeatData(Guid id) {
            try {
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    conn.Open();
                    string SQL = "deleteBeatData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.Parameters.AddWithValue("@ID", id);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.ExecuteNonQuery();
        ...
        public void deleteBeatSegmentData(Guid id)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
                {
                    conn.Open();
                    string SQL = "deleteBeatSegmentData";
                    SqlCommand cmd = new SqlCommand(SQL, conn);
                    cmd.Parameters.AddWithValue("@ID", id);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.ExecuteNonQuery();
        ...
        public void deleteCallBoxData(Guid id)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
        ...
        public void deleteDropSiteData(Guid id)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
        ...
        public void deleteYardData(Guid id)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnStr))
            ...
            try {
                ...
                using (SqlConnection conn = new SqlConnection(ConnStr)) {
                    ...
                    while (rdr.Read()) {
                        ...
                        d.UserPosted = rdr.IsDBNull(13) ? "NA" : rdr["UserPosted"].ToString();
                        dList.Add(d);
                    }
                    rdr.Close();
                    rdr = null;
