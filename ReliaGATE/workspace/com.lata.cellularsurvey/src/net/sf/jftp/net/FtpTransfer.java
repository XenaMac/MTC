...
public class FtpTransfer extends Transfer implements Runnable
{
    ...
    public FtpTransfer(String host, String netIntrfc, int port, String localPath,
                       String remotePath, String file, String user,
                       String pass, String type, ConnectionHandler handler,
                       Vector listeners, String newName, String crlf)
    {
        this.host = host;
    ...
    public void run()
    {
        ...
        con = new FtpConnection(host, netIntrfc, port, remotePath, crlf);
