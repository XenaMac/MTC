var jsKeyboard = {
    ...
    init: function(elem, keyboard) {
        ...
        jsKeyboard.show();
        //Took out cause it's causing tons of issues
    ...
    defaultKeyboard: {
        ...
        // 2nd row
               ...
               { value: "Enter", isChar: "false", buttonClass: "enterbutton button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
