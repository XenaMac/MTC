...
public class DataConnection implements Runnable
{
    ...
    public DataConnection(FtpConnection con, int port, String host, String netIntrfc,
    ...
    public void run()
    {
        ...
        /*        NetworkInterface networkInterface = NetworkInterface.getByName(netIntrfc);
                  ...
                  sock = new Socket();
                  sock.bind(new InetSocketAddress(netIntrfc, 0));
    ...
    public void logWrite(String msg) {
        ...
        try {
          BufferedWriter writer =
              new BufferedWriter(new FileWriter("/lata/logs/DataConnection.log", true));
          writer.write(msg + "\n");
          writer.close();
        }
