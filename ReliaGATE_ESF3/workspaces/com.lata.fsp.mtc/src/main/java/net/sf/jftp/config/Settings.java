...
public class Settings
{
    ...
    public static boolean getUseJTableLayout()
    {
        String what = p.getProperty("jftp.useJTableLayout", "true");
    ...
    static
    {
        ...
        if(!getUseNewIcons()) {
        	...
        	helpImage = "images/silk/help.png";
        }
        else {  
        	iconImage = "images/silk/server_add.png";
        	hostImage = "images/silk/server_add.png";   
        	closeImage = "images/silk/cancel.png";
        	infoImage = "images/silk/information.png";  
        	listImage = "images/silk/page_white_text.png";  

        	rmdirImage = "images/silk/folder_delete.png";  
        	mkdirImage = "images/silk/folder_add.png";   
        	refreshImage = "images/silk/control_repeat.png";
        	refreshImage2 = "images/silk/control_repeat_blue.png"; 
        	cdImage = "images/silk/folder_explore.png"; 
        	cmdImage = "images/silk/application_xp_terminal.png";   
        	downloadImage = "images/silk/arrow_left.png";
        	uploadImage = "images/silk/arrow_right.png";
        	fileImage = "images/silk/page_white.png";
        	dirImage = "images/silk/folder.png"; 
        	codeFileImage = "images/silk/page_white_wrench.png";
        	textFileImage = "images/silk/page_white_text.png";
        	execFileImage = "images/silk/cog.png";
        	audioFileImage = "images/silk/ipod.png";
        	videoFileImage = "images/silk/camera.png";
        	htmlFileImage = "images/silk/html.png";
        	zipFileImage = "images/silk/page_white_zip.png";
        	imageFileImage = "images/silk/image.png";
        	presentationFileImage = "images/silk/page_white_powerpoint.png";
        	spreadsheetFileImage = "images/silk/page_excel.png";
        	bookFileImage = "images/silk/book.png";  
        	copyImage = "images/silk/disk_multiple.png";   
        	openImage = "images/silk/drive_web.png";
        	sftpImage = "images/silk/drive_link.png";
        	nfsImage = "images/silk/drive_network.png";
        	webdavImage = "images/silk/house_go.png";  
        	linkImage = "images/silk/arrow_right.png";
        	typeImage = "images/silk/email_go.png";
        	deleteImage = "images/silk/control_stop.png"; 
        	deleteImage2 = "images/silk/control_stop_blue.png"; 
        	clearImage = "images/silk/control_eject.png"; 
        	clearImage2 = "images/silk/control_eject_blue.png"; 
        	resumeImage = "images/silk/control_play.png";
        	resumeImage2 = "images/silk/control_play_blue.png";
        	pauseImage = "images/silk/control_pause.png";
        	pauseImage2 = "images/silk/control_pause_blue.png";
        	saveImage = "images/silk/disk.png";
        	cdUpImage = "images/silk/arrow_up.png";
        	nextRSSImage = "images/silk/rss_go.png";
        	helpImage = "images/silk/help.png";
        }
