...
public class UpdateIntervals implements CellularSurveyConstants{
	private int dataRecordSeconds = DATA_RECORD_DEFAULT;
	private int downloadUpdateSeconds = -1;
	private int uploadUpdateSeconds = -1;
	private int pingUpdateSeconds = -1;
	private String dataRecordSecondsStr = "5";
	private String downloadUpdateSecondsStr = "3";
	private String uploadUpdateSecondsStr = "3";
	private String pingUpdateSecondsStr ="3";
