...
public class FtpUpload implements ConnectionListener, Logger, FtpConstants, CellularSurveyConstants {
  ...
  public FtpUpload(FTPClient fTPClient, int clientIndex, String netIntrfc, String host, String localDir, String logDir,
      String file, String username, String password, int uploadUpdateSeconds, boolean logging)
  {
    ...
    logWrite(" FtpUpload " + clientIndex + "started with host: " + host + " dir: " + localDir + " file: " + file 
    ...
    if (ftpConnection.login(username, password) == LOGIN_OK) {
      ...
      ftpConnection.handleUpload(file);
      while(connected)
      {
        try { 
          Thread.sleep(100); 
