...
public class FtpConnection implements BasicConnection, FtpConstants
{
    ...
    *
    * @param host The host to connect to
    * @param netIntrfc The network interface used for the connection
    */
    
    public FtpConnection(String host, String netIntrfc)
    {
        this.host = host;
    ...
    */
    public FtpConnection(String host, String netIntrfc, int port, String initCWD, String crlfx)
    {
        this.host = host;
        this.netIntrfc = netIntrfc;
        this.port = port;
    ...
    */
    public int login(String username, String password)
    {
        ...
        jcon = new JConnection(host, netIntrfc, port);
    ...
    */
    public int handleDownload(String file)
    {
        if(Settings.getEnableMultiThreading())
        {
            ...
            FtpTransfer t = new FtpTransfer(host, netIntrfc, port, getLocalPath(),
    ...
    */
    ...
    private int rawDownload(String file)
    {
        ...
        try
        {
            ...
            dcon = new DataConnection(this, p, host, netIntrfc, path, dataType, resume); //, new Updater());
    ...
    */
    public int handleUpload(String file, String realName)
    {
               ...
               (!Settings.getNoUploadMultiThreading()))
        {
            ...
            if(realName != null)
            {
                t = new FtpTransfer(host, netIntrfc, port, getLocalPath(), getCachedPWD(),
...
/*                    		if(JOptionPane.showConfirmDialog(new JLabel(), "A file smaller than the one to be uploaded already exists on the server,\n do you want to resume the upload?", "Resume upload?", JOptionPane.YES_NO_OPTION)
            ...
            dcon = new DataConnection(this, p, host, netIntrfc, path, dataType, resume,
